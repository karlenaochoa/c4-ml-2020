...
knn_clas_best <- knn_clas_res %>%
  select_best(metric = "roc_auc")

# Finalize your model using the best tuning parameters
knn_clas_mod_final <- knn_clas_mod %>%
  finalize_model(knn_clas_best) 

# Finalize your recipe using the best turning parameters
knn_clas_rec_final <- knn_clas_rec %>% 
  finalize_recipe(knn_clas_best)

# Run your last fit on your initial data split
knn_clas_test_results <- knn_clas_mod_final %>% 
    last_fit(preprocessor = knn_clas_rec_final,
             split = math_split)

#Collect metrics
knn_clas_test_results %>% 
  collect_metrics()
```
